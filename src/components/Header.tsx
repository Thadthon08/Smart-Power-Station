...
export default function Header() {
  const { user, isAuthenticated, logout, mockGoogleLogin } = useAuthStore();
      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <div>
              <h1 className="text-xl font-bold text-white">Jay Corp</h1>
              <p className="text-xs text-white/60">Task Management System</p>
            </div>
          </motion.div>
          ...
          >
            {isAuthenticated && user ? (
              ...
              <motion.button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-white text-gray-900 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all"
              >
