          ...
          <div className="mt-8 space-y-4">
            {[
              ...
              <motion.div
                ...
                className="flex items-center gap-4 p-4 bg-white rounded-xl border border-sky-200 hover:border-sky-400 transition-all cursor-pointer"
              >
                ...
                <button className="px-4 py-2 bg-sky-100 text-sky-600 rounded-lg text-sm font-semibold hover:bg-sky-200 transition-colors">
                  ดูเอกสาร
                </button>
              </motion.div>
            ))}
